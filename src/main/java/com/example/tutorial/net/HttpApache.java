...
//    }
//
//    public static void callSche() throws IOException {
//        Map<String, String> params = Maps.newHashMap();
//        params.put("name", "GetVendorResourceIdsByConnectNoTask.Galaxy");
//        params.put("cronParamJson", "[{\"cron\":]");
//        params.put("state", "true");
//        params.put("alertState", "true");
//        HttpClient httpClient = HttpClients.createDefault();
//
//        Map<String, String> cronParams = Maps.newHashMap();
//        cronParams.put("cron", "0 0 10/6 * * ?");
//        cronParams.put("param", "");
//
//        HttpPost httpPost = new HttpPost("http://qschedule.fws.qa.nt.ctripcorp.com/api2/job/update.do");
//
//        Gson gson = new Gson();
//
...
//        }
//        UrlEncodedFormEntity encodedFormEntity = new UrlEncodedFormEntity(form, StandardCharsets.UTF_8);
//
...
//        int ri = 0;
//        while ((ri = response.getEntity().getContent().read(buff, 0, 1000)) > 0) {
//            swapStream.write(buff, 0, ri);
//        }
//        String resBody = new String(swapStream.toByteArray(), StandardCharsets.UTF_8);
