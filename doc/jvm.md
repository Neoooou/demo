...
![image-20230403100021102](/Users/zhangran/Library/Application Support/typora-user-images/image-20230403100021102.png)
...
GC的主要场所，当Java创建一个类的实例对象和数组时，都会在堆中分配内存；在结构上可以分为新生代和老年代，新生代又可分为Eden和两个Survivor空间，比例为8：1：1；由于新生代对象98%都是朝生夕死的，所以不需要按照1：1进行划分；两个survivor来回进行复制，避免内存碎片化带来的空间和性能损失。
